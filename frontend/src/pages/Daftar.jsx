...
const roles = [
  {
    ...
    title: "Saya mau cari pekerja",
    desc: "Temukan ART, tukang, kru acara, dan montir terpercaya di sekitarmu",
  },
  {
    id: "pekerja",
    to: "/daftar/pekerja",
    illustration: ilustrasiTerima,
    title: "Saya mau terima pekerjaan",
    desc: "Daftarkan keahlianmu dan dapatkan pelanggan di Manado",
  },
];
...
const Daftar = () => {
  ...
  return (
    <AuthShell>
      <div className="relative w-full max-w-3xl rounded-[28px] border border-[#EAE5DB] bg-white px-6 py-6 shadow-[0_30px_70px_rgba(13,59,46,0.12)] sm:px-10">
        ...
        <div className="mt-7 text-center">
          ...
          <p className="mt-1.5 text-sm text-moss">
            Pilih peran yang paling sesuai untukmu.
          </p>
        </div>
